...
* Intended pipeline:    mriqc_singSub => mriqc_groupLevel => this script

Usage

* Download the group_bold.tsv output

python3 postQA.py group_bold.tsv

Ouput

* One PDF with summaries of frame displacmenet % for all functional scans
